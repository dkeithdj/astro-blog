const id = "astro-blog.md";
						const collection = "blogs";
						const slug = "astro-blog";
						...
						const data = {author:"arron-bur",categories:["astrology"],date:"December 1, 2023",featured:false,image:
						new Proxy({"src":"/_astro/jwst.O11YTuFh.png","width":2000,"height":1158,"format":"png"}, {
					...
					,title:"Astrology, the ancient art"};
						const _internal = {
							type: 'content',
							filePath: "/home/denrei/codes/web/astro-tut/astro-blog/src/content/blogs/astro-blog.md",
